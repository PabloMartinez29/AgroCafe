<x-guest-layout>
    <div class="h-screen flex items-center justify-center bg-white relative overflow-hidden">
        ...
        <!-- Main Content -->
        <div class="relative z-10 w-full max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-8 lg:py-12 h-full flex items-center">
            <div class="grid lg:grid-cols-2 gap-8 lg:gap-16 items-start w-full">
                ...
                <div class="text-center lg:text-left animate-slide-in-left">
                    ...
                    <h1 class="text-5xl lg:text-7xl font-extrabold text-gray-900 mb-4 tracking-tight leading-tight animate-fade-in-up">
                        Únete a <span class="text-coffee-600 bg-gradient-to-r from-coffee-600 to-coffee-800 bg-clip-text text-transparent">AgroCafé</span>
                    </h1>
                    <p class="text-gray-600 text-lg lg:text-xl mb-8 animate-fade-in-up-delayed">Crea tu cuenta y comienza a gestionar tu negocio cafetero</p>
                    ...
                    <div class="space-y-4 text-gray-700 animate-fade-in-up-delayed-2">
                        <div class="flex items-center justify-center lg:justify-start group">
                            <div class="w-10 h-10 bg-coffee-100 rounded-full flex items-center justify-center mr-4 group-hover:bg-coffee-200 transition-colors">
                                <i class="fas fa-user-plus text-coffee-600"></i>
                            </div>
                            <span class="text-base font-medium">Registro rápido y sencillo</span>
                        </div>
                        <div class="flex items-center justify-center lg:justify-start group">
                            <div class="w-10 h-10 bg-coffee-100 rounded-full flex items-center justify-center mr-4 group-hover:bg-coffee-200 transition-colors">
                                <i class="fas fa-shield-alt text-coffee-600"></i>
                            </div>
                            <span class="text-base font-medium">Datos seguros y protegidos</span>
                        </div>
                        <div class="flex items-center justify-center lg:justify-start group">
                            <div class="w-10 h-10 bg-coffee-100 rounded-full flex items-center justify-center mr-4 group-hover:bg-coffee-200 transition-colors">
                                <i class="fas fa-rocket text-coffee-600"></i>
                            </div>
                            <span class="text-base font-medium">Acceso inmediato al sistema</span>
                        </div>
                    </div>
                </div>

                <!-- Right Side - Register Form -->
                <div class="w-full animate-slide-in-right max-h-[90vh] overflow-y-auto pr-2 custom-scrollbar">
                    <!-- Register Card -->
                    <div class="bg-white rounded-3xl shadow-2xl p-8 sm:p-10 lg:p-12 border-2 border-coffee-100 relative overflow-hidden group hover:shadow-3xl transition-all duration-500">
                        ...
                        <div class="relative z-10">
                            <div class="mb-8 text-center lg:text-left">
                                <h2 class="text-3xl lg:text-4xl font-bold text-gray-900 mb-2 animate-fade-in">Crear Cuenta</h2>
                                <p class="text-gray-600 animate-fade-in-delayed">Completa el formulario para registrarte</p>
                            </div>
        ...
        @csrf
                                ...
                                <div class="space-y-2 animate-slide-up" style="animation-delay: 0.1s;">
                                    <label for="name" class="block text-sm font-bold text-gray-700">
                                        <i class="fas fa-user text-coffee-600 mr-2"></i>
                                        Nombre Completo
                                    </label>
                                    <div class="relative group">
                                        <div class="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
                                            <i class="fas fa-user text-gray-400 group-focus-within:text-coffee-600 transition-colors duration-300"></i>
                                        </div>
                                        <input 
                                            id="name" 
                                            name="name" 
            ...
            <x-input-error :messages="$errors->get('email')" class="mt-2" />
                                ...
                                <div class="space-y-2 animate-slide-up" style="animation-delay: 0.25s;">
                                    <label for="phone" class="block text-sm font-bold text-gray-700">
                                        <i class="fas fa-phone text-coffee-600 mr-2"></i>
                                        Teléfono
                                    </label>
                                    <div class="relative group">
                                        <div class="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
                                            <i class="fas fa-phone text-gray-400 group-focus-within:text-coffee-600 transition-colors duration-300"></i>
                                        </div>
                                        <input 
                                            id="phone" 
                                            name="phone" 
                                ...
                                <div class="space-y-2 animate-slide-up" style="animation-delay: 0.3s;">
                                    <label for="address" class="block text-sm font-bold text-gray-700">
                                        <i class="fas fa-map-marker-alt text-coffee-600 mr-2"></i>
                                        Dirección
                                    </label>
                                    <div class="relative group">
                                        <div class="absolute inset-y-0 left-0 pl-4 pt-4 flex items-start pointer-events-none">
                                            <i class="fas fa-map-marker-alt text-gray-400 group-focus-within:text-coffee-600 transition-colors duration-300"></i>
                                        </div>
                                        <textarea 
                                            id="address" 
                                            name="address" 
                                            required 
                                            rows="3"
                                            class="block w-full pl-12 pr-4 py-4 border-2 border-gray-200 rounded-xl text-gray-900 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-coffee-500 focus:border-coffee-500 transition-all duration-300 bg-gray-50 focus:bg-white transform focus:scale-[1.02] resize-none"
            ...
            <x-input-error :messages="$errors->get('password_confirmation')" class="mt-2" />
                                ...
                                <div class="pt-2 animate-slide-up" style="animation-delay: 0.5s;">
                                    ...
                                    >
                                        ...
                                        <i class="fas fa-user-plus mr-2 group-hover:translate-x-1 transition-transform duration-300"></i>
                                        Crear Cuenta
                                    </button>
                                </div>

                                <!-- Login Link -->
                                <div class="text-center pt-4 animate-slide-up" style="animation-delay: 0.6s;">
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            if (togglePasswordConfirmation && passwordConfirmationInput && eyeIconConfirmation) {
                togglePasswordConfirmation.addEventListener('click', function() {
                    ...
                    eyeIconConfirmation.style.transform = 'scale(0) rotate(180deg)';
                    setTimeout(() => {
                        if (type === 'password') {
                        ...
                        eyeIconConfirmation.style.transform = 'scale(1) rotate(0deg)';
                    }, 150);
                });
            }
