...
@section('title', 'Nuevo Tipo de Café - Administrador')
@section('page-title', 'Crear Nuevo Tipo de Café')
    ...
    <div class="w-full max-w-3xl">
        <div class="bg-white rounded-2xl shadow-lg border border-gray-100 overflow-hidden">
            ...
            <div class="bg-gradient-to-r from-coffee-600 to-coffee-700 px-8 py-6">
                ...
                <p class="text-coffee-100 mt-1">Completa el formulario para crear un nuevo tipo de café</p>
            </div>

            <!-- Contenido del formulario -->
            <form action="{{ route('admin.coffee-types.store') }}" method="POST" class="p-8">
                @csrf
                ...
                <div class="space-y-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        >
                            ...
                            <option value="arabica" {{ old('variety') === 'arabica' ? 'selected' : '' }}>Arábica</option>
                            <option value="robusta" {{ old('variety') === 'robusta' ? 'selected' : '' }}>Robusta</option>
                        </x-select>
                        ...
                        >
                            ...
                            <option value="special" {{ old('quality') === 'special' ? 'selected' : '' }}>Especial</option>
                            <option value="commercial" {{ old('quality') === 'commercial' ? 'selected' : '' }}>Comercial</option>
                        </x-select>
                        ...
                        >
                            <option value="normal" {{ old('processing_type', 'normal') === 'normal' ? 'selected' : '' }}>Normal</option>
                            <option value="wet" {{ old('processing_type') === 'wet' ? 'selected' : '' }}>Mojado</option>
                            <option value="dry" {{ old('processing_type') === 'dry' ? 'selected' : '' }}>Seco</option>
                            <option value="pasilla" {{ old('processing_type') === 'pasilla' ? 'selected' : '' }}>Pasilla</option>
                        </x-select>
